  ...
  return (
    ...
    >
      <Animated.View entering={FadeInDown.springify()} style={styles.header}>
        ...
        <Text style={[styles.subtitle, { color: theme.textSecondary }]}>Simple rules for a simple tool.</Text>
      </Animated.View>

      <View style={styles.content}>
        <Point delay={100} icon="create-outline" title="Generated Content" desc="You are solely responsible for the content of the QR codes you generate using this application." />
        <Point delay={200} icon="warning-outline" title="Scanned Links" desc="Please exercise caution. Users are responsible for verifying the safety of any scanned links before opening them." />
        <Point delay={300} icon="shield-half-outline" title="No Warranty" desc="QR Master is provided 'as is' without warranty. We accept no liability for damages resulting from using the app." />
        <Point delay={400} icon="save-outline" title="Data Persistence" desc="Data is stored locally on your device. Uninstalling the app or clearing app data will result in permanent data loss." />
      </View>
      
      <Animated.View entering={FadeInDown.delay(500).springify()} style={styles.footer}>
        <View style={{ opacity: 0.7, alignItems: 'center', paddingBottom: 20 }}>
          <Text style={{ color: theme.icon, fontSize: 13 }}>By using QR Master, you agree to these terms.</Text>
        </View>
      </Animated.View>
    </ScrollView>
  );
